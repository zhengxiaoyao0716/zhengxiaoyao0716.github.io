// load babel, by zhengxiaoyao0716.
try {
    eval("() => {}");
} catch (error) {
    HTMLElement.prototype.before = HTMLElement.prototype.before || function (node) { this.parentElement.insertBefore(node, this); };
    Array.prototype.forEach.call(document.querySelectorAll("script:not([type='text/babel'])"), function (script) {
        if (!script.src || (String.prototype.endsWith ? script.src.endsWith(".js") : script.src.slice(-3) == ".js")) {
            return;
        }
        script.before((function (s) {
            s.src = script.src;
            s.type = "text/babel";
            return s;
